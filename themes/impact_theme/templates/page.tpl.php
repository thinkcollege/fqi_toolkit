        ...
        <div id="slider">
          <div id="slider-wrap">
            <div class="slides displayblock">
              <img width="644" height="320" src="<?php print base_path() . drupal_get_path('theme', 'impact_theme') . '/images/island-slider.png'; ?>" class="pngfix"/>
            </div> <!-- .slides -->

            <div class="slides displaynone">
              <img width="644" height="320" src="<?php print base_path() . drupal_get_path('theme', 'impact_theme') . '/images/sanctuary-slider.png'; ?>" class="pngfix"/>
            </div> <!-- .slides -->

            <div class="slides displaynone">
              <a href="http://futurereadyma.org/"><img width="644" height="320" src="<?php print base_path() . drupal_get_path('theme', 'impact_theme') . '/images/ma-career-slider.png'; ?>" class="pngfix"/></a>
             </div> <!-- .slides -->

             <div class="slides displaynone">
              <a href="http://www.resources21.org/"><img width="644" height="320" src="<?php print base_path() . drupal_get_path('theme', 'impact_theme') . '/images/clp-slider.png'; ?>" class="pngfix"/></a>
            </div> <!-- .slides -->

            <div class="slides displaynone">
              <img width="644" height="320" src="<?php print base_path() . drupal_get_path('theme', 'impact_theme') . '/images/hopaboard-slider.png'; ?>" class="pngfix"/>
            </div> <!-- .slides -->

            <div class="slides displaynone">
              <a href="http://www.thinkcollege.net/"><img width="644" height="320" src="<?php print base_path() . drupal_get_path('theme', 'impact_theme') . '/images/tc-slider.png'; ?>" class="pngfix"/></a>
             </div> <!-- .slides -->

             <div class="slides displaynone">
              <img width="644" height="320" src="<?php print base_path() . drupal_get_path('theme', 'impact_theme') . '/images/dock-slider.png'; ?>" class="pngfix"/>
            </div> <!-- .slides -->
